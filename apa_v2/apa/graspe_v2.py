...
def busca_local(solucao, matriz):
    """Fase de busca local: tenta trocar pares para reduzir o valor total."""
    atual = list(solucao)
    melhor = atual[:]
